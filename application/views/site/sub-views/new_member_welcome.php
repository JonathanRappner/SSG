...
<div id="new_member_welcome" class="row mb-4 p-0 pr-1">
	...
	<div class="card mr-4 bg-white border-0 shadow-sm">
		...
		<p>Vad roligt att du är här! Vi ser gärna att du registrerar dig på hemsidan så att du får mer tillgång till vad som händer och du får även tillgång till forumet.</p>
		...
		<p>Tack!</p>
		<img src="https://www.ssg-clan.se/images/ssg_2021_frontpage.jpg" alt="Welcome">
		...
		<p>Vi lånar till viss mån rutiner och arbetssätt från verkligheten som vi sedan har anpassat till att fungera i spelet med fokus på spelnöje och effektivitet. Vi är dock inte intresserade av hur någonting görs i verkligheten om det begränsar oss istället för att lägga till spelglädje.</p>
